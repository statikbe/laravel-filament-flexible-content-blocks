...
namespace Statikbe\FilamentFlexibleContentBlocks\Filament\Form\Fields\Blocks\Overview;
    ...
    class OverviewType
    {
        ...
        public function getTitleColumnName(): string
        {
            if (blank($this->titleColumnName)) {
                throw new \Exception("Overview type [{$this->getModel()}] must have a [titleColumnName()] set.");
            }
