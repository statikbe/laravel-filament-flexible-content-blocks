...
class CallToActionData
{
    ...
    {
        if (! (empty($callToActionBlockData[CallToActionField::FIELD_URL]) ||
                empty($callToActionBlockData[CallToActionField::FIELD_ROUTE]) ||
                empty($callToActionBlockData[CallToActionField::FIELD_CTA_MODEL]))) {
